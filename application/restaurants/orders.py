...
from application.models.order import Order, OrderItem, ORDER_PAID, \
                                     ORDER_PENDING
from application.database import db
from application.models.menu import Item
from application.auth import current_identity, only_manager, authenticated_user
from application.email import send_email
from application.utils import get_current_restaurant
